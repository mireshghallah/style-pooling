...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, help="this is a directory", default="data/blogs_3dom_cleaned")
    ...
    parser.add_argument('--domains', type=int, help="this is the number of domains", default=3)
        ...
        with open(trains[i], "r") as fin:
            for line in fin:
                ...
                if cnt < args.max_unk:
                    ...
                    WRITE = False 
                    if i == 0 :
                        if  all_cnt%(args.domains+1) == 0 or all_cnt%(args.domains+1) == 1:
                            WRITE = True
                    elif (i == 1 and all_cnt%(args.domains+1) == 0):
                        WRITE = True
                    elif i == 2 and all_cnt%(args.domains+1) != 3:
                        WRITE = True
